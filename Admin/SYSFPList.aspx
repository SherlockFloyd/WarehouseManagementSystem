<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SYSFPList.aspx.cs" Inherits="Admin_SYSFPList" %>
                            ...
                            <tr>
                                <td >
                                    <table  
                                        ...
                                        <tr>
                                           <td height="25" width="30%" align="center" class="tdHeader"> [实验室分配工作人员]</td>
                            	...
                            	<asp:GridView ID="gvData" runat="server" AllowPaging="True" 
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="代码" HeaderText="代码" Visible="False" >
                                           ...
                                           <asp:BoundField DataField="实验室名称" HeaderText="实验室名称" >
                                            <ItemStyle HorizontalAlign="Center"    />
                                            <HeaderStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                         <asp:BoundField DataField="实验室位置" HeaderText="实验室位置" >
                                            <ItemStyle HorizontalAlign="Center"    />
                                            <HeaderStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                          ...
                                          <asp:BoundField DataField="姓名" HeaderText="工作人员" > 
                                            <ItemStyle HorizontalAlign="Center" />
                                            <HeaderStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        ...
                                        <asp:TemplateField HeaderText="操作">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="btn_Modify" runat="server" BackColor="Transparent" 
                                                    BorderStyle="None" CommandName="Mod" ForeColor="#3a6ea5" Text="分配员工"></asp:LinkButton>
                                            </ItemTemplate>
