<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CLList.aspx.cs" Inherits="Admin_CLList" %>
   ...
   <div align="center">
                            ...
                            <tr>
                                <td >
                                    <table  
                                        ...
                                        <tr>
                                           <td height="25" width="30%" align="center" class="tdHeader"> [车辆信息维护管理]</td>
		...
		<asp:ImageButton ID="btnQuery" runat="server" 
            ImageUrl="~/images/button_search.GIF" onclick="btnQuery_Click" />
				...
				<asp:BoundField DataField="载重量" HeaderText="载重量" >
		</asp:BoundField>
				<asp:BoundField DataField="安全里程" HeaderText="安全里程" >
		</asp:BoundField>
				<asp:BoundField DataField="行驶里程" HeaderText="行驶里程" >
		</asp:BoundField>
