...
public partial class Admin_CLList : System.Web.UI.Page
{
    ...
    private void BindResult()
    {
        ...
        //组合查询条件 
        DataTable dt = DataControl.GetData("select * from  车辆信息 where 车牌号 like '%"+TextBox1.Text+"%'  ");
        if (dt != null)
        {
            this.gvData.DataKeyNames = new string[] { "车牌号" };
    ...
    protected void gvData_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            string strUrl = "CL.aspx?ID=" + gvData.DataKeys[num]["车牌号"].ToString();
            PageBase.OpenWebForm(strUrl);
        }
        else if (e.CommandName == "Del")
        {
            DataControl.Execute("delete from 车辆信息 where 车牌号='" + gvData.DataKeys[num]["车牌号"].ToString() + "'");
            BindResult();
        }
    }
