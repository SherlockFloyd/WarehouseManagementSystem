<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YPXSY.aspx.cs" Inherits="Admin_YPXSY" %>
                            ...
                            <tr>
                                <td >
                                    <table  
                                        ...
                                        <tr>
                                           <td height="25" width="30%" align="center" class="tdHeader"> [货物销售月报表]</td>
                            ...
                            <td>
                            	<asp:GridView ID="gvData" runat="server" AllowPaging="True" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="销售比数" HeaderText="销售比数" />
