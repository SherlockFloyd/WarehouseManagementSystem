<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RZQuery.aspx.cs" Inherits="GZRY_RZQuery" %>
                            ...
                            <tr>
                                <td >
                                    <table  
                                        ...
                                        <tr>
                                           <td height="25" width="30%" align="center" class="tdHeader"> [货物库存管理]</td>
                            ...
                            <td>
                            	<asp:GridView ID="gvData" runat="server" AllowPaging="True" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="库存上限" HeaderText="库存上限" />
                                        <asp:BoundField DataField="库存下限" HeaderText="库存下限" />
                                        
                                        <asp:TemplateField HeaderText="操作" Visible="False">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="btn_Modify" runat="server" BackColor="Transparent" 
                                                    BorderStyle="None" CommandName="Mod" ForeColor="#3a6ea5" Text="设置库存"></asp:LinkButton>
                                            </ItemTemplate>
