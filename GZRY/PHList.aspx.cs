...
public partial class GZRY_PHList : System.Web.UI.Page
{
    ...
    private void BindResult()
    {
        ...
        //组合查询条件 
        DataTable dt = DataControl.GetData("select * from  V_配货 where 配送单号 like '%" + TextBox1.Text + "%' and 名称 like '%" + TextBox2.Text + "%' and 配送记录 is null");
        if (dt != null)
        {
    ...
    protected void gvData_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            string strUrl = "PHD.aspx?ID=" + gvData.DataKeys[num]["配送单号"].ToString();
