<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PSD.aspx.cs" Inherits="Admin_PSD" %>
...
<table cellSpacing="0" cellPadding="0" border="0" class="table">
	...
	<td height="25" align="center" class="tdHeader" colspan="2">
        ...
        <td style="width: 235px; text-align: left; height: 18px;">
                                <asp:TextBox id="txt配送单号" runat="server" Width="200px"></asp:TextBox>
        ...
        <td style="width: 235px; text-align: left; height: 18px;">
		 ...
		 配送日期：</td>
        <td style="width: 235px; text-align: left; height: 18px;">
                                <asp:TextBox id="txt配送日期" runat="server" Width="200px"></asp:TextBox>
        ...
        <td style="width: 235px; text-align: left; height: 18px;">
		 ...
		 客户签收：</td>
        <td style="width: 235px; text-align: left; height: 18px;">
                                <asp:TextBox id="txt客户签收" runat="server" Width="200px" TextMode="MultiLine"></asp:TextBox>
